...
use crate::gpio::{Alternate1, Floating, Input, Pin, Pin0, Pin1, Pin2};
...
impl TimerPeriph for pac::TIMER_0_A3 {
    type Tbxclk = Pin<P1, Pin2, Alternate1<Input<Floating>>>;
}
impl CapCmpTimer3 for pac::TIMER_0_A3 {}

impl TimerPeriph for pac::TIMER_1_A3 {
    type Tbxclk = Pin<P1, Pin1, Alternate1<Input<Floating>>>;
}
impl CapCmpTimer3 for pac::TIMER_1_A3 {}
/*
impl TimerPeriph for pac::TIMER_2_A2 {
    type Tbxclk = Pin<PORT_3_4, Pin2, Alternate1<Input<Floating>>>;
}
impl CapCmpTimer3 for pac::TIMER_2_A2 {}
*/
impl TimerPeriph for pac::TIMER_0_B7 {
    type Tbxclk = Pin<P2, Pin0, Alternate1<Input<Floating>>>;
}
impl CapCmpTimer7 for pac::TIMER_0_B7 {}
