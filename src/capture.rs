...
impl CapturePeriph for pac::TIMER_0_A3 {
    type Gpio1 = Pin<P1, Pin6, Alternate3<Input<Floating>>>;
    type Gpio2 = Pin<P1, Pin7, Alternate3<Input<Floating>>>;
    type Gpio3 = ();
    type Gpio4 = ();
    type Gpio5 = ();
    type Gpio6 = ();
...
impl CapturePeriph for pac::TIMER_1_A3 {
    type Gpio1 = Pin<P2, Pin3, Alternate1<Input<Floating>>>;
    type Gpio2 = Pin<P2, Pin4, Alternate1<Input<Floating>>>;
    type Gpio3 = ();
    type Gpio4 = ();
    type Gpio5 = ();
    type Gpio6 = ();
